...
<div class="banner">
    <div class="container">
        <div style="margin-left:auto;margin-right:auto;display:table;">
            ...
            <p ><h3 class="text-center"><strong>一个慵懒的程序员</strong></h3></p>
        </div>
    </div>
</div>
...
<footer class="text-center navbar navbar-default ">
    <p style="margin:auto">
        <small>Powered by:<a href="mailto:zmanliang@163.com">zmanliang@163.com</a>|<a href="http://www.miitbeian.gov.cn/" target="_blank">京ICP备15031683号</a></small>
    </p>
</footer>
</body>
